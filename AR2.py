...
def sex():
  ...
  id = "|".join(uuid)
  print("\n\n\x1b[32;1m  YOUR KEY : \033[99m"+id) 
  try: 
    httpCaht = requests.get("https://raw.githubusercontent.com/FOX-AR/Approval.txt/main/Approval.txt").text 
    if id in httpCaht: 
      ...
      os.system('xdg-open https://wa.me/+8801972239643?text=*Hello*%2C%20*ANTO*%20*i*%20*want*%20*to*%20*buy*%20*your*%20*command*%20*Random*%20*clone*')
      time.sleep(3) 
      sys.exit() 
  except: 
    sys.exit() 
